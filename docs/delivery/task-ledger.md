...
```json
{
  "task": "ISSUE-7",
  "state": "needs_review",
  "current_action": "Builder opened PR #13 for issue #7 and QA plus Security review are now in progress.",
  "next_action": "Await QA and Security callbacks for PR #13, then route to Spec if both pass.",
